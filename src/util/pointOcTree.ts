...
// 向八叉树中添加数据
function put(point: Cartesian3, data: any, octree: PointOctree, octant: PointOctant, depth: number): boolean {
...
function cull(octant: PointOctant, sphere: BoundingSphere, result: PointOctant[]) {
...
export class PointOctree {
  ...
  constructor(min: Cartesian3, max: Cartesian3, bias: number, maxPoints: number, maxDepth: number) {
